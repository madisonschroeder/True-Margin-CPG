...
- tollProcessing: co-packing/manufacturing fee per unit in $ (e.g., 0.25)
...
Total Manufacturing COGS = rawIngredients + primaryPackaging + secondaryPackaging + tollProcessing + inboundFreight
